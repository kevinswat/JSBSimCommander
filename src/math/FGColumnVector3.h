...
#define ID_COLUMNVECTOR3 "$Id: FGColumnVector3.h,v 1.1.1.1 2006/04/30 23:38:57 jberndt Exp $"
...
/** This class implements a 3 dimensional vector.
    ...
    @version $Id: FGColumnVector3.h,v 1.1.1.1 2006/04/30 23:38:57 jberndt Exp $
*/
